    ...
    <header className="relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-center">
        ...
        <div className="flex justify-center items-center gap-4 mb-6">
          ...
          <Shell className="w-8 h-8 text-gold animate-float" />
        ...
        <div className="h-1 w-48 mx-auto bg-gradient-to-r from-transparent via-gold to-transparent mb-6" />
        
        <p className="font-display text-xl md:text-2xl text-gold-light italic mb-2">
